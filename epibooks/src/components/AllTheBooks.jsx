      ...
      <Row className="justify-content-between align-items-center mb-3">
        ...
        <Col xs="auto">
          <DropdownButton id="dropdown-basic-button" title="Select Category">
            <Dropdown.Item onClick={() => changeCategory("horror")}>
              Horror
            </Dropdown.Item>
            <Dropdown.Item onClick={() => changeCategory("fantasy")}>
              Fantasy
            </Dropdown.Item>
            <Dropdown.Item onClick={() => changeCategory("thriller")}>
              Thriller
            </Dropdown.Item>
            <Dropdown.Item onClick={() => changeCategory("romance")}>
              Romance
            </Dropdown.Item>
            <Dropdown.Item onClick={() => changeCategory("scifi")}>
              Sci-Fi
            </Dropdown.Item>
          </DropdownButton>
        </Col>
